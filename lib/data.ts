...
export const products: Product[] = [
  ...
  },
  {
    id: "squadstudy",
    title: "SquadStudy",
    category: "EdTech / Social Learning Platform",
    description:
      "A next-generation collaborative study platform where students can share notes, discuss topics, and stay productive together in real-time.",
    longDescription:
      "SquadStudy is a modern student-focused learning platform built to make studying faster, smarter, and more collaborative. The platform provides a lightning-fast social feed for sharing study materials, real-time discussions, offline note support, instant notifications, and a distraction-free interface optimized for deep focus. Designed as a Progressive Web App (PWA), SquadStudy allows students to stay connected with their study squad anytime, anywhere.",
    tech: [
      "Next.js",
      "TypeScript",
      "MongoDB",
    ...
    image: "/squadstudy.png",
    color: "from-violet-600 to-indigo-500",
    features: [
      "Lightning Fast Study Feed",
    ...
    liveUrl: "https://squadstudy.vercel.app/",
  },
  {
    id: "lumina-books",
    title: "Lumina Books",
    category: "Desktop Inventory / POS Management System",
    description:
      "A modern offline-first bookstore management solution with inventory tracking, POS billing, analytics, and local-first data security.",
    longDescription:
      "Lumina Books is a powerful desktop-first bookstore management system designed for modern bookshops that need speed, reliability, and full offline support. The platform combines smart inventory management, lightning-fast POS billing, sales analytics, barcode scanning, and local database control into one seamless experience. Built with Electron and the MERN ecosystem, Lumina Books delivers native desktop performance while keeping all business data secure and fully accessible without internet connectivity.",
    tech: [
      "Next.js",
      "TypeScript",
      "React 19",
    ...
    liveUrl: "https://myluminabooks.vercel.app/",
  },
  {
    id: "3d-dog",
    title: "3D Dog",
